        ...
        <ul class="menu">
            <li class="menu-text eng-font small-fontsize-2 grey-text">
                @if(Auth::guard('web_admin')->user())
                    <span>{{Auth::guard('web_admin')->user()->email}}</span>
                    <i class="fa fa-user-circle-o"></i>
                @endif
            </li>
            <li><a class="button tiny small-fontsize alert" href="{{url('/admin/logout')}}">خروج</a></li>
        </ul>
    </div>
</div>
...
<div class="top-bar">
    <div id="main-menu" class="top-bar-left">
        <ul class="menu white-text mid-fontsize">
            <li>
                <a href="{{url('/admin/dashboard')}}"><i class="fa fa-bar-chart fa-flip-horizontal">
                    </i><span class="bold-font padding-horizontal-0-3 small-fontsize-2"> داشبورد </span>
                </a>
            </li>

            <li>
                <a href="{{url('/admin/tickets')}}"><i class="fa fa-commenting-o"></i>
                    <span class="bold-font padding-horizontal-0-3 small-fontsize-2"> درخواست‌ها </span>
                </a>
            </li>

            <li>
                <a href="{{url('/admin/invoices')}}"><i class="fa fa-th-large"></i>
